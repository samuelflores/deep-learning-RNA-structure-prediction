...
# allow for residue number skipping in decoy generation. generate decoys only from the chain from which the tetraloop originates

# update chain ID in bottaro's dataset
